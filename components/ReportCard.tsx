    ...
    <article className="paper-panel space-y-5 p-5">
      ...
      <section className="grid gap-3 md:grid-cols-2">
        <div className="paper-inset p-4">
          <p className="text-sm font-semibold text-[#2f241d]">简要结论</p>
          <p className="mt-2 text-sm leading-7">{generatedReport.summary}</p>
        </div>
        <div className="paper-inset p-4">
          <p className="text-sm font-semibold text-[#2f241d]">当前问题重述</p>
          <p className="mt-2 text-sm leading-7">{generatedReport.restatedQuestion}</p>
        </div>
      </section>

      <section className="paper-inset p-4">
        <p className="text-sm font-semibold text-[#2f241d]">用户资料整理</p>
        <p className="mt-2 text-sm leading-7">{generatedReport.userProfile}</p>
      </section>

      <section className="paper-inset p-4">
        <p className="text-sm font-semibold text-[#2f241d]">分析结果</p>
      ...
      {unlocked ? (
        <section className="space-y-4 rounded-3xl border border-[#2f6b48]/45 bg-[#dce8d4] p-4 text-[#214632]">
          ...
          <div>
            <p className="text-sm font-semibold">现实建议</p>
            <ul className="mt-2 space-y-2 text-sm leading-7 text-[#31563f]">
          ...
          <div>
            <p className="text-sm font-semibold">可继续追问</p>
            <ul className="mt-2 space-y-2 text-sm leading-7 text-[#31563f]">
      ...
      <section className="paper-inset p-4">
        <p className="text-sm font-semibold text-[#2f241d]">不建议做的事</p>
        <ul className="mt-3 space-y-2 text-sm leading-7">
      ...
      <section className="paper-inset p-4">
        <p className="text-sm font-semibold text-[#2f241d]">报告风险提醒</p>
        <p className="mt-2 text-sm leading-7">{generatedReport.riskReminder}</p>
      </section>
